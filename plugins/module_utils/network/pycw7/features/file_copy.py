...
from ansible_collections.community.network.plugins.module_utils.network.pycw7.features.errors import FileNotEnoughSpaceError,\
    FileNotReadableError, FileRemoteDirDoesNotExist, FileTransferError, FileHashMismatchError
from ansible_collections.community.network.plugins.module_utils.network.pycw7.errors import NCError
